...
def run(args):
    ...
    train_data, val_data, _ = load_data(data, data_dir, binarize = binarize_flag, augment_extend=augment_extend_flag)
    ...
    _, _, test_data = load_data(data, data_dir, binarize = binarize_flag)
    ...
    if model_save:
        ...
        torch.save(pf_circuit, result_dir + '/' + name + '/pf_circuit.pt')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_save', action='store_true', help='Save model or not')
